                                       ...
                                       stereo_msgs::DisparityImage& disparity) const
{
  ...
  cv::Mat disp, buf;
  block_matcher_(left_rect, right_rect, disp);
  //optional
  bm::filterSpeckles( disp, 0, speckleSize, diffThreshold, buf);
  disparity16_.create(disp.rows, disp.cols);
  disp.convertTo(disparity16_, CV_16S, 16, -1);
